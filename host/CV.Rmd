...
- Cincinnati Childhood Allergy and Air Pollution Study (CCAAPS)
    ...
    + Working to compare the effectiveness and efficiency of Voronoi diagrams vs. square rasters in interpolating Land Use Random Forest predictions over the Greater Cincinnati area
...
- 2018 Joint Statistical Meetings, *Co-author on Second Place team*
    ...
    + Presented my own data-centric model for evaluating error in weather forecasts, which did not place in the competition
...
Robert C. Garrett, Austin Nar, Thomas J. Fisher, Karsten Maurer. 2018.  ggvoronoi: Voronoi Diagrams and Heatmaps with 'ggplot2'. R package version 0.8.1.
